...
Test file for recursion handling - contains extremely complex mathematical
expressions that exceed Python's default recursion limit during AST parsing.
This file tests the bytecode compiler's ability to handle deep recursion.
"""
